...
namespace QLNS.Controllers
{
    public class tblTheLoaisController : Controller
    {
        ...
        // GET: tblTheLoais/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: tblTheLoais/Create
